...
<div class="card">
	<div class="card-header">
		<ul class="nav card-header-pills">
			<li class="nav-item">
				<a class="nav-item float-xs-left btn btn-link disabled"><?= count($this->users) ?> users(s)</a>
				<a class="nav-item float-xs-right btn btn-secondary" href="/users/create"><i class="fa fa-plus"></i> Add</a>
			</li>
		</ul>
	</div>
