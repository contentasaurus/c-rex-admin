...
<div class="card">
	<div class="card-header">
		<ul class="nav card-header-pills">
			<li class="nav-item">
				<a class="nav-item pull-xs-left btn btn-link disabled" style="color:black"><?= count($this->components) ?> Component(s)</a>
				<a class="nav-item pull-xs-right btn btn-secondary" href="/components/create"><i class="fa fa-plus"></i> Add</a>
			</li>
		</ul>
	</div>
